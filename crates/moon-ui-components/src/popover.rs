...
impl Popover {
    ...
    /// Set any element as trigger without requiring [`Selectable`].
    pub fn trigger_any<E>(mut self, trigger: E) -> Self
    where
        E: IntoElement + 'static,
    {
        self.trigger = Some(Box::new(|_, _, _| trigger.into_any_element()));
        self
    }
    ...
    /// Set whether clicking inside the content should dismiss the popover.
    ...
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let popover_content =
            Self::render_popover_content(self.anchor, self.appearance, window, cx)
                ...
                .when(self.close_on_content_click, |this| {
