...
impl PopupMenuItem {
    ...
    /// Set whether activating this item should dismiss the containing popup menu.
    ///
    /// Checklist/dropdown menus use this to let the user toggle several items without
...
impl PopupMenu {
    ...
    /// Set popup menu density/row sizing.
    ...
    pub fn submenu(
        ...
        self.submenu_with_icon_and_disabled(None, label, false, window, cx, f)
    }

    /// Add a disabled/enabled submenu.
    pub fn submenu_with_disabled(
        ...
        self.submenu_with_icon_and_disabled(None, label, disabled, window, cx, f)
    }
    ...
    pub fn submenu_with_icon(
        ...
        self.submenu_with_icon_and_disabled(icon, label, false, window, cx, f)
    }
    ...
    fn render_item(
        ...
        let (item_height, radius) = match self.size {
            ...
            Size::Size(height) => (height, options.radius.half()),
