...
impl Size {
    ...
    pub fn table_cell_padding(&self) -> Edges<Pixels> {
        match self {
            Size::XSmall => Edges { top: px(0.), bottom: px(0.), left: px(10.), right: px(8.) },
            Size::Small | Size::Medium => {
                Edges { top: px(0.), bottom: px(0.), left: px(12.), right: px(8.) }
            }
            Size::Large => Edges { top: px(0.), bottom: px(0.), left: px(12.), right: px(10.) },
            Size::Size(_) => Edges { top: px(0.), bottom: px(0.), left: px(12.), right: px(8.) },
        }
    }
...
mod tests {
    ...
    fn test_table_row_height() {
        assert_eq!(Size::XSmall.table_row_height(), px(22.));
        assert_eq!(Size::Small.table_row_height(), px(25.));
        assert_eq!(Size::Medium.table_row_height(), px(25.));
        assert_eq!(Size::Large.table_row_height(), px(30.));
        assert_eq!(Size::Size(px(48.)).table_row_height(), px(48.));
    }

    #[test]
    fn test_table_cell_padding() {
        let compact = Size::XSmall.table_cell_padding();
        assert_eq!(compact.top, px(0.));
        assert_eq!(compact.bottom, px(0.));
        assert_eq!(compact.left, px(10.));
        assert_eq!(compact.right, px(8.));

        let normal = Size::Medium.table_cell_padding();
        assert_eq!(normal.top, px(0.));
        assert_eq!(normal.bottom, px(0.));
        assert_eq!(normal.left, px(12.));
        assert_eq!(normal.right, px(8.));
    }
